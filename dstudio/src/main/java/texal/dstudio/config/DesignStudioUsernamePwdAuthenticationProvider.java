...
//
//public class DesignStudioUsernamePwdAuthenticationProvider implements AuthenticationProvider {
//    @Autowired
...
//                authorities.add(new SimpleGrantedAuthority(customer.get(0).getRole().name()));
//
